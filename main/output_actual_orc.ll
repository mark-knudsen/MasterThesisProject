...
entry:
  ...
  %len_field_ptr = getelementptr inbounds nuw { i64, i64, ptr }, ptr %x_load, i32 0, i32 0
  %data_field_ptr = getelementptr inbounds nuw { i64, i64, ptr }, ptr %x_load, i32 0, i32 2
...
bounds.ok:                                        ; preds = %entry
  ...
  %1 = ptrtoint ptr %raw_val to i64
  %value_mem = call ptr @malloc(i64 8)
  store i64 %1, ptr %value_mem, align 4
