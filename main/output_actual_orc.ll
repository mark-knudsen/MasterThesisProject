...
@str.38 = private unnamed_addr constant [3 x i8] c"HI\00", align 1
@str.39 = private unnamed_addr constant [3 x i8] c"HI\00", align 1
...
entry:
  ...
  store i64 4, ptr %elem_ptr84, align 8
  ...
  store ptr %arr_header38, ptr %1, align 8
  %2 = getelementptr inbounds nuw %dataframe, ptr %df, i32 0, i32 2
  store ptr %arr_header43, ptr %2, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %record_ptr = call ptr @malloc(i64 ptrtoint (ptr getelementptr ({ i64, i64 }, ptr null, i32 1) to i64))
  %__current_row_load89 = load ptr, ptr @__current_row, align 8
  %ptr_latitude = getelementptr ptr, ptr %__current_row_load89, i64 1
  %val_latitude = load double, ptr %ptr_latitude, align 8
  %fsubtmp = fsub double %val_latitude, 1.000000e+02
  %field_0 = getelementptr inbounds nuw { i64, i64 }, ptr %record_ptr, i32 0, i32 0
  store double %fsubtmp, ptr %field_0, align 8
  %field_1 = getelementptr inbounds nuw { i64, i64 }, ptr %record_ptr, i32 0, i32 1
  store i64 ptrtoint (ptr @str.38 to i64), ptr %field_1, align 8
  %__current_row_load90 = load ptr, ptr @__current_row, align 8
  %record_ptr91 = call ptr @malloc(i64 ptrtoint (ptr getelementptr ({ i64, i64 }, ptr null, i32 1) to i64))
  %__current_row_load92 = load ptr, ptr @__current_row, align 8
  %ptr_latitude93 = getelementptr ptr, ptr %__current_row_load92, i64 1
  %val_latitude94 = load double, ptr %ptr_latitude93, align 8
  %fsubtmp95 = fsub double %val_latitude94, 1.000000e+02
  %field_096 = getelementptr inbounds nuw { i64, i64 }, ptr %record_ptr91, i32 0, i32 0
  store double %fsubtmp95, ptr %field_096, align 8
  %field_197 = getelementptr inbounds nuw { i64, i64 }, ptr %record_ptr91, i32 0, i32 1
  store i64 ptrtoint (ptr @str.39 to i64), ptr %field_197, align 8
  %3 = getelementptr ptr, ptr %__current_row_load90, i64 0
  %loaded_field = load ptr, ptr %3, align 8
  %4 = getelementptr ptr, ptr %record_ptr91, i64 0
  %loaded_field98 = load ptr, ptr %4, align 8
  %5 = getelementptr ptr, ptr %__current_row_load90, i64 2
  %loaded_field99 = load ptr, ptr %5, align 8
  %6 = getelementptr ptr, ptr %__current_row_load90, i64 3
  %loaded_field100 = load ptr, ptr %6, align 8
  %7 = getelementptr ptr, ptr %__current_row_load90, i64 4
  %loaded_field101 = load ptr, ptr %7, align 8
  %8 = getelementptr ptr, ptr %__current_row_load90, i64 5
  %loaded_field102 = load ptr, ptr %8, align 8
  %9 = getelementptr ptr, ptr %__current_row_load90, i64 6
  %loaded_field103 = load ptr, ptr %9, align 8
  %10 = getelementptr ptr, ptr %__current_row_load90, i64 7
  %loaded_field104 = load ptr, ptr %10, align 8
  %11 = getelementptr ptr, ptr %__current_row_load90, i64 8
  %loaded_field105 = load ptr, ptr %11, align 8
  %12 = getelementptr ptr, ptr %__current_row_load90, i64 9
  %loaded_field106 = load ptr, ptr %12, align 8
  %13 = getelementptr ptr, ptr %__current_row_load90, i64 10
  %loaded_field107 = load ptr, ptr %13, align 8
  %14 = getelementptr ptr, ptr %__current_row_load90, i64 11
  %loaded_field108 = load ptr, ptr %14, align 8
  %15 = getelementptr ptr, ptr %__current_row_load90, i64 12
  %loaded_field109 = load ptr, ptr %15, align 8
  %16 = getelementptr ptr, ptr %__current_row_load90, i64 13
  %loaded_field110 = load ptr, ptr %16, align 8
  %17 = getelementptr ptr, ptr %__current_row_load90, i64 14
  %loaded_field111 = load ptr, ptr %17, align 8
  %18 = getelementptr ptr, ptr %__current_row_load90, i64 15
  %loaded_field112 = load ptr, ptr %18, align 8
  %19 = getelementptr ptr, ptr %__current_row_load90, i64 16
  %loaded_field113 = load ptr, ptr %19, align 8
  %20 = getelementptr ptr, ptr %__current_row_load90, i64 17
  %loaded_field114 = load ptr, ptr %20, align 8
  %21 = getelementptr ptr, ptr %__current_row_load90, i64 18
  %loaded_field115 = load ptr, ptr %21, align 8
  %22 = getelementptr ptr, ptr %__current_row_load90, i64 19
  %loaded_field116 = load ptr, ptr %22, align 8
  %23 = getelementptr ptr, ptr %__current_row_load90, i64 20
  %loaded_field117 = load ptr, ptr %23, align 8
  %24 = getelementptr ptr, ptr %__current_row_load90, i64 21
  %loaded_field118 = load ptr, ptr %24, align 8
  %25 = getelementptr ptr, ptr %__current_row_load90, i64 22
  %loaded_field119 = load ptr, ptr %25, align 8
  %26 = getelementptr ptr, ptr %__current_row_load90, i64 23
  %loaded_field120 = load ptr, ptr %26, align 8
  %27 = getelementptr ptr, ptr %__current_row_load90, i64 24
  %loaded_field121 = load ptr, ptr %27, align 8
  %28 = getelementptr ptr, ptr %__current_row_load90, i64 25
  %loaded_field122 = load ptr, ptr %28, align 8
  %29 = getelementptr ptr, ptr %__current_row_load90, i64 26
  %loaded_field123 = load ptr, ptr %29, align 8
  %30 = getelementptr ptr, ptr %__current_row_load90, i64 27
  %loaded_field124 = load ptr, ptr %30, align 8
  %31 = getelementptr ptr, ptr %__current_row_load90, i64 28
  %loaded_field125 = load ptr, ptr %31, align 8
  %32 = getelementptr ptr, ptr %__current_row_load90, i64 29
  %loaded_field126 = load ptr, ptr %32, align 8
  %33 = getelementptr ptr, ptr %__current_row_load90, i64 30
  %loaded_field127 = load ptr, ptr %33, align 8
  %34 = getelementptr ptr, ptr %__current_row_load90, i64 31
  %loaded_field128 = load ptr, ptr %34, align 8
  %35 = getelementptr ptr, ptr %__current_row_load90, i64 32
  %loaded_field129 = load ptr, ptr %35, align 8
  %36 = getelementptr ptr, ptr %__current_row_load90, i64 33
  %loaded_field130 = load ptr, ptr %36, align 8
  %37 = getelementptr ptr, ptr %__current_row_load90, i64 34
  %loaded_field131 = load ptr, ptr %37, align 8
  %38 = getelementptr ptr, ptr %__current_row_load90, i64 35
  %loaded_field132 = load ptr, ptr %38, align 8
  %39 = getelementptr ptr, ptr %__current_row_load90, i64 36
  %loaded_field133 = load ptr, ptr %39, align 8
  %40 = getelementptr ptr, ptr %record_ptr91, i64 1
  %loaded_field134 = load ptr, ptr %40, align 8
...
grow:                                             ; preds = %for.body
  %41 = icmp eq i64 %cap, 0
  %42 = mul i64 %cap, 2
  %new_cap = select i1 %41, i64 4, i64 %42
