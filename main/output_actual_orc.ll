...
for.body:                                         ; preds = %for.cond
  ...
  %ptr_age = getelementptr %struct_name_age_hasJob, ptr %__current_row_load19, i32 0, i32 1
  %val_age = load i64, ptr %ptr_age, align 8
  %field_0 = getelementptr %struct_age, ptr %record_ptr, i32 0, i32 0
  store i64 %val_age, ptr %field_0, align 8
  %__current_row_load20 = load ptr, ptr @__current_row, align 8
  %record_ptr21 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (%struct_age, ptr null, i32 1) to i64))
  %__current_row_load22 = load ptr, ptr @__current_row, align 8
  %ptr_age23 = getelementptr %struct_name_age_hasJob, ptr %__current_row_load22, i32 0, i32 1
  %val_age24 = load i64, ptr %ptr_age23, align 8
  %field_025 = getelementptr %struct_age, ptr %record_ptr21, i32 0, i32 0
  store i64 %val_age24, ptr %field_025, align 8
  %0 = getelementptr ptr, ptr %__current_row_load20, i64 0
  %loaded_field = load ptr, ptr %0, align 8
  %1 = getelementptr ptr, ptr %record_ptr21, i64 0
  %loaded_field26 = load ptr, ptr %1, align 8
  %2 = getelementptr ptr, ptr %__current_row_load20, i64 2
  %loaded_field27 = load ptr, ptr %2, align 8
  %rec_ptr = call ptr @malloc(i64 24)
  ...
  store ptr %loaded_field27, ptr %slot_2, align 8
...
for.end:                                          ; preds = %for.cond
  %__map_result_load32 = load ptr, ptr @__map_result, align 8
  ...
  store ptr %__map_result_load32, ptr %data_ptr, align 8
  ret ptr %runtime_obj
...
cont:                                             ; preds = %grow, %for.body
  %data_phi = phi ptr [ %data31, %for.body ], [ %realloc, %grow ]
