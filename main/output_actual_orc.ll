...
entry:
  ...
  %unbox_gep = getelementptr inbounds nuw { i32, ptr }, ptr %x_load, i32 0, i32 1
  %array_header = load ptr, ptr %unbox_gep, align 8
  %len_ptr = getelementptr inbounds nuw { i64, i64, ptr }, ptr %array_header, i32 0, i32 0
  %cap_ptr = getelementptr inbounds nuw { i64, i64, ptr }, ptr %array_header, i32 0, i32 1
  %data_ptr_ptr = getelementptr inbounds nuw { i64, i64, ptr }, ptr %array_header, i32 0, i32 2
...
add_cont:                                         ; preds = %grow, %entry
  ...
  store ptr bitcast (i64 200 to ptr), ptr %target_ptr, align 8
