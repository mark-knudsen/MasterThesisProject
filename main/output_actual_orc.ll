...
%struct_name = type { ptr }
%struct_name_age_cool = type { ptr, i64, i8 }
...
entry:
  ...
  store i64 1, ptr %cap_ptr, align 8
  ...
  store i64 1, ptr %cap_ptr9, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %record_ptr = call ptr @malloc(i64 ptrtoint (ptr getelementptr (%struct_name, ptr null, i32 1) to i64))
  %__current_row_load = load ptr, ptr @__current_row, align 8
  %ptr_name = getelementptr %struct_name_age_cool, ptr %__current_row_load, i32 0, i32 0
  %val_name = load ptr, ptr %ptr_name, align 8
  %field_0 = getelementptr %struct_name, ptr %record_ptr, i32 0, i32 0
  store ptr %val_name, ptr %field_0, align 8
...
for.step:                                         ; preds = %cont
  %x_load21 = load i64, ptr @__map_i, align 8
  %inc_add = add i64 %x_load21, 1
  store i64 %inc_add, ptr @__map_i, align 8
  br label %for.cond, !llvm.loop !0

for.end:                                          ; preds = %for.cond
  %__map_result_load22 = load ptr, ptr @__map_result, align 8
  ...
  store ptr %__map_result_load22, ptr %data_ptr, align 8
  ret ptr %runtime_obj
