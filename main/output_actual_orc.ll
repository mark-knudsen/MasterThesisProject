...
entry:
  ...
  store ptr %df2_load, ptr @__col_src, align 8
...
df_idx_merge:                                     ; preds = %df_idx_ok, %df_idx_err
  ...
  %ptr_name = getelementptr %struct_name_age_hasJob, ptr %__col_row_load, i32 0, i32 0
...
cont:                                             ; preds = %grow, %df_idx_merge
  ...
  %target_slot_ptr = getelementptr ptr, ptr %final_data_ptr, i64 %len7
  store ptr %val_name, ptr %target_slot_ptr, align 8
