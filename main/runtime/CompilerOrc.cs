...
//         // public object Run(NodeExpr expr, bool generateIR = false) // bruh this returns null, why we running this?
//         // {
//         //     // 1. SEMANTIC ANALYSIS
...
//             // convert it back to a Pointer immediately so the rest of the CompilerOrc can use it.
...
//                 "void" => MyType.None,
//                 "array" => MyType.Array,
//                 _ => throw new Exception($"CompilerOrc Error: Type '{name}' is not recognized.")
//             };
//         }
