...
%token REMOVE REMOVERANGE LENGTH MIN MAX MEAN SUM CORR COPY RECORD ADDFIELD REMOVEFIELD WHERE MAP FUNC ADD ADDRANGE 
...
expr
    ...
    | expr DOT SELECT LPAREN LBRACKET expr_list RBRACKET RPAREN { $$ = new ShowDataframeNode($1 as ExpressionNode, $6 as List<ExpressionNode>); }
