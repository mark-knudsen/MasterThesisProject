...
%left GE LE EQ NE GT LT      // lowest
%left PLUS MINUS
%left MULT DIV               // highest
...
Statement
    ...
    | FOR LPAREN Assignment SEMICOLON Statement SEMICOLON Assignment RPAREN Statement { $$ = new ForLoopNodeExpr($3 as StatementNodeExpr, $5 as ExpressionNodeExpr, $7 as StatementNodeExpr, $9 as ExpressionNodeExpr); }
    | FOR LPAREN Assignment SEMICOLON Statement SEMICOLON Assignment SEMICOLON RPAREN Statement { $$ = new ForLoopNodeExpr($3 as StatementNodeExpr, $5 as ExpressionNodeExpr, $7 as StatementNodeExpr, $10 as ExpressionNodeExpr); }
    ;
