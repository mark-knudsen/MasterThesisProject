...
%token ADD ADDRANGE REMOVE REMOVERANGE LENGTH MIN MAX MEAN SUM CAPACITY
...
assignment 
    ...
    | expr DOT CAPACITY ASSIGN expr    { $$ = new CapacityNode($1 as ExpressionNode, $5 as ExpressionNode); }
...
expr
    ...
    | expr DOT CAPACITY                     { $$ = new CapacityNode($1); }
